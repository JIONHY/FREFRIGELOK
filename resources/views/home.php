...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>FRE</b>FRIGEL</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                  ...
                  <li>
                    ...
                    <ul class="menu">
                      <li><!-- start message -->
                        <a href="#">
                          <div class="pull-left">
                            <img src="adminlte/img/photo1.png" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Support Team
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="adminlte/img/photo2.png" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                      ...
                      <li>
                        <a href="#">
                          <div class="pull-left">
                            <img src="adminlte/img/photo3.jpg" class="img-circle" alt="User Image">
                          </div>
                          <h4>
                            Sales Department
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="plnatilla/img/photo1.png" class="user-image" alt="User Image">
                  <span class="hidden-xs">AdmFrefrigel</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="adminlte/img/photo2.png" class="img-circle" alt="User Image">
                    <p>
                      Empresa Frefrigel - Web Developer
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="pages/widgets.html">
                <i class="fa fa-th"></i> <span>Inventario Inicial</span> <small class="label pull-right bg-green">new</small>
              </a>
            </li>
            <li class="treeview">
              <a href="#">
            ...
            <section class="col-lg-7 connectedSortable">
              ...
              <div class="box box-success">
                ...
                <div class="box-body chat" id="chat-box">
                  ...
                  <!-- chat item -->
                  <div class="item">
                    <img src="adminlte/img/photo1.png" alt="user image" class="offline">
                    <p class="message">
                      <a href="#" class="name">
              ...
              <div class="box box-primary">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Lista de quehaceres</h3>
                ...
                <div class="box-body">
                  <ul class="todo-list">
                    ...
                    <li>
                      ...
                      <input type="checkbox" value="" name="">
                      <span class="text">Hacer el tema sensible</span>
                    ...
                    <li>
                      ...
                      <input type="checkbox" value="" name="">
                      <span class="text">Deja que el tema brille como una estrell</span>
                    ...
                    <li>
                      ...
                      <input type="checkbox" value="" name="">
                      <span class="text">Déjalos brillar como una estrella</span>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2018 <a href="http://frefrigel.com">Cpanelfrefrigel</a>.</strong> All rights reserved.
      </footer>
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="bootstrap/plugins\jQueryUI/jquery-ui.min.js"></script>
    ...
    <!-- Morris.js charts -->
    <script src="bootstrap/plugins/raphael-min.js"></script>
    ...
    <!-- daterangepicker -->
    <script src="bootstrap/plugins/moment.min.js"></script>
