...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      if (this.showInputs) {
        hourTemplate = '<input type="text" name="hour" classadminlte-timepicker-hour form-control" maxlength="2"/>';
        minuteTemplate = '<input type="text" name="minute" classadminlte-timepicker-minute form-control" maxlength="2"/>';
        secondTemplate = '<input type="text" name="second" classadminlte-timepicker-second form-control" maxlength="2"/>';
        meridianTemplate = '<input type="text" name="meridian" classadminlte-timepicker-meridian form-control" maxlength="2"/>';
      } else {
        hourTemplate = '<span classadminlte-timepicker-hour"></span>';
        minuteTemplate = '<span classadminlte-timepicker-minute"></span>';
        secondTemplate = '<span classadminlte-timepicker-second"></span>';
        meridianTemplate = '<span classadminlte-timepicker-meridian"></span>';
      }
      ...
      case 'modal':
        template = '<div classadminlte-timepicker-widget modal hide fade in" data-backdrop="'+ (this.modalBackdrop ? 'true' : 'false') +'">'+
        ...
        break;
      case 'dropdown':
        template = '<div classadminlte-timepicker-widget dropdown-menu">'+ templateContent +'</div>';
        break;
      }
